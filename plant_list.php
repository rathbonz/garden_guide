...
<body>
    <div class="navbar"> 
        ...
        <nav>
            ...
            <ul class="primary-nav">
                <li><a class="current" href="plant_list.php">Plant List</a></li>
    ...
    <section class="hero">
        <div class="container plant-list">
            <h1>Plant List</h1>
            ...
            <h3>Click <a href="#" class="green-link">here</a> to add plants from the Plant Library<br><br>
                Click <a href="#" class="green-link">here</a> to go to your Calendar<br><br>
            </h3>
        </div>
    </section>
</body>
